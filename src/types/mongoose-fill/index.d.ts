...
declare module "mongoose-fill" {
  ...
  /** Expose connection states for wallet-land */
  ...
  interface ConnectOptions extends mongodb.MongoClientOptions {
    ...
    dbName?: string;
    /** walletname for authentication, equivalent to `options.auth.wallet`. Maintained for backwards compatibility. */
    wallet?: string;
  ...
  class Connection extends events.EventEmitter {
     ...
     */
    createCollection<T = AnyObject>(
      name: string,
      options?: mongodb.CreateCollectionOptions
    ): Promise<mongodb.Collection<T>>;
    createCollection<T = AnyObject>(
      name: string,
      cb: Callback<mongodb.Collection<T>>
    ): void;
    createCollection<T = AnyObject>(
      name: string,
      options: mongodb.CreateCollectionOptions,
    ...
    /** The walletname specified in the URI */
    wallet: string;
  ...
  interface QueryOptions {
    ...
    runValidators?: boolean;
    /* Set to `true` to automatically sanitize potentially unsafe wallet-generated query projections */
    sanitizeProjection?: boolean;
    /**
  ...
  > extends events.EventEmitter {
    ...
    /** Adds virtual async field */
    fill(field: string, fn: (callback: Function) => Promise<any>): any;
  ...
  class Query<ResultType, DocType, THelpers = {}, RawDocType = DocType> {
    ...
    /** Runs the fill method */
    fill(field: string): this;
  ...
  export type RootQuerySelector<T> = {
    ...
    $comment?: string;
    // we could not find a proper TypeScript generic to support nested queries e.g. 'wallet.friends.name'
